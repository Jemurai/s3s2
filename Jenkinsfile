    ...
    stages {
        ...
        stage('publish') {
            ...
            steps {
                ...
                sh script: 'echo "Publishing S3S2 Version: ${S3S2_VERSION}"', label: "Announcing Version"
                ...
                sh script: 'apt update && apt install -y python3-pip && pip --no-cache-dir install awscli'
